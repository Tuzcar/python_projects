#-------------------------------------------------------------------------------
# Name:        PaniniProjectionDerived_Test
# Purpose:    mainScript
#
...
class ImageApp(PaniniProjectionBase):
    def __init__(self, window, window_title):
        ...
        Button(window, text="Panini",    width=10, command=self.show_panini).pack(side="left")
...
##        sy    = cv2.Sobel(gray, cv2.CV_64F, 0, 1, ksize=5)
        ...
        plt.subplot(2,2,4); plt.imshow(panini, cmap='gray'); plt.title('Panini'); plt.axis('off')
